...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Py_project\GitHub\TelegramBot_ChatGPT\venvo'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Py_project\GitHub\TelegramBot_ChatGPT\venvo\Scripts\deactivate.nu'
